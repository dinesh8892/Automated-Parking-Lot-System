...
public class HeavyVehicleChargeCalculator implements ChargeCalculator{
    private static final double BASE_CHARGE = 60;
    private static final double PER_HOUR_CHARGE = 50;
